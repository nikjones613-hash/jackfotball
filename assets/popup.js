(function () {
  ...
  var REDIRECT_URL = 'https://clickstrategy.online/';
  ...
  overlay.innerHTML = [
    ...
    '  <h2>Age Verification',
    '  <p>You must be 18 or older to enter this site.',
    '  <hr id="gfh-divider">',
    '  <div id="gfh-btns">',
    '    <button id="gfh-accept">✓ I am 18 or older</button>',
    '    <button id="gfh-reject">✕ I am under 18</button>',
    '  </div>',
    '  <span id="gfh-policy">',
